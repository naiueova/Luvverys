            ...
            <div class="card-body">
                <form action="{{ route('customer.store') }}" id="frmCustomer" method="POST">
                    ...
                    <div class="mb-3 ms-3 me-3">
                        ...
                        <input class="form-control" id="phone" name="phone" type="number" placeholder="Phone" aria-label="Password">
                    </div>
                    <div class="mb-3 ms-3 me-3">
                        <label for="address1" class="form-label">Address1</label>
                        <input class="form-control" id="address1" name="address1" type="text" placeholder="Address1" aria-label="Address1">
                    </div>
                    <div class="mb-3 ms-3 me-3">
                        <label for="address2" class="form-label">Address2</label>
                        <input class="form-control" id="address2" name="address2" type="text" placeholder="Address2" aria-label="Address2">
                    </div>
                    <div class="mb-3 ms-3 me-3">
                        <label for="address3" class="form-label">Address3</label>
                        <input class="form-control" id="address3" name="address3" type="text" placeholder="Address3" aria-label="Address3">
                    </div>
