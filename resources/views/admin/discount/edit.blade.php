...
@section('main')
    ...
    <div class="container-xl px-4 mt-n10">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('discount.update', $discount->id) }}" id="frmDiscount" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-3 ms-3 me-3">
                        <label for="code" class="form-label">Code</label>
                        <input class="form-control" id="code" name="code" type="text" placeholder="Code"
                            aria-label="Code" value="{{ $discount->code ?? '' }}">
                    </div>

                    <div class="mb-3 ms-3 me-3">
                        <label for="name" class="form-label">Name</label>
                        <input class="form-control" id="name" name="name" type="text" placeholder="Name"
                            aria-label="Name" value="{{ $discount->name ?? '' }}">
                    </div>
                    ...
                    <div class="mb-3 ms-3 me-3">
                        ...
                        <select class="form-select" aria-label="Default select example" name="type" id="type">
                            ...
                            <option value="percentage" {{ $discount->type == 'percentage' ? 'selected' : '' }}>Precentage</option>
                    ...
                    <div class="mb-3 ms-3 me-3">
                        ...
                        <input class="form-control" id="discount_amount" name="discount_amount" type="number"
                            placeholder="Discount Amount" aria-label="Discount Amount" value="{{ $discount->discount_amount ?? '' }}">
                    </div>
